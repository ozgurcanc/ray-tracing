...
class LightMesh : public Light, public ObjectInfo
{
public:
	LightMesh(BVH * object, Matrix4& transform, int matIndex, Vector3 motion, bool smoothShading, int texIndex[2], int texOffset);
